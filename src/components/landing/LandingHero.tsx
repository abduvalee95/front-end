...
export function LandingHero() {
  ...
  return (
    <section className="relative overflow-hidden landing-mesh-bg landing-grain">
      {/* Decorative colour fields behind the hero — see .landing-aurora. */}
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 lg:gap-12 items-center">
          ...
          <div className="relative landing-tilt">
            <div className="landing-tilt-inner">
              ...
              <div
                className="absolute -left-4 top-6 z-20 rounded-xl bg-white ring-soft border border-slate-200 px-3 py-2.5 w-[200px] landing-float-lift"
                style={{ animationDelay: '.4s', '--landing-lift': '78px' } as CSSProperties}
              >
              ...
              <div
                className="absolute -right-3 bottom-12 z-20 rounded-xl bg-white ring-soft border border-slate-200 px-3 py-2.5 w-[210px] landing-float-lift"
                style={{ animationDelay: '1.6s', '--landing-lift': '46px' } as CSSProperties}
              >
                <div className="flex items-center gap-2">
              ...
              <div className="absolute -z-10 -inset-8 brand-grad opacity-[0.18] rounded-[40px] blur-3xl landing-tilt-back"></div>
            </div>
          </div>
        </div>
      </div>
