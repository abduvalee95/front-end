...
export function TeacherPrompt() {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <p className="text-h4 text-foreground">{t('select_teacher')}</p>
      <p className="mt-1.5 max-w-xs text-caption text-muted-foreground">{t('select_teacher_desc')}</p>
    </div>
  );
}
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <p className="text-h4">{hasFilters ? t('no_matching_students') : t('no_students_yet')}</p>
      <p className="mt-1.5 max-w-xs text-caption text-muted-foreground">
        {teacherScoped ? t('enroll_first') : t('add_first')}
      </p>
      {hasFilters && (
        <Button variant="outline" size="sm" onClick={onClear} className="mt-4 rounded-xl text-caption h-8">
...
export function ErrorState({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <p className="text-h4">Failed to load students</p>
      <p className="mt-1.5 text-caption text-muted-foreground">Check backend connection and try again.</p>
      <Button variant="outline" size="sm" onClick={onRetry} className="mt-4 rounded-xl text-caption h-8">
